    ...
    return (
      <Center py={12} key={NAME + "b"} className="project-card" >
        <Box
          ...
          pos={"relative"}
          zIndex={1}
          style={{boxShadow: "box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;"}}
        >
          <Box
            rounded={"lg"}
            mt={-12}
          ...
          <Stack pt={10} align={"center"}>
            ...
            <Stack direction={"row"} color={"white.600"} align={"left"}>
              <Wrap spacing="10px" justify="space-between" h={"60px"}>
                {TECHSTACK.map((tech, i) => (
                  <WrapItem key={i + "abc"} className="project-tech-stack">
                    <Center
                      variant="solid"
                      fontWeight={600}
                      w="100px"
